...
public class Topology {
	...
	private LinkedList<LinkPhyEdge> listLinkPhyEdge; // bandwidth of all
														// Phy->Edge switch link
	...
	private Map<Integer, LinkedList<SubstrateSwitch>> listEdgeSwitchInPod; // list
																			// edge
																			// switch
																			// in
																			// pod
	private Map<Integer, LinkedList<SubstrateSwitch>> listAggSwitchInPod; // list
																			// agg
																			// switch
																			// in
																			// pod
	private LinkedList<SubstrateSwitch> listPhySwitch; // gia physical server la
														// mot switch

	private Map<SubstrateSwitch, SubstrateSwitch> listCoreToCore;
	...
	public Topology() {
		...
		listCoreToCore = new HashMap<>();
	}

	public Topology(Map<SubstrateSwitch, LinkedList<SubstrateSwitch>> mapInput,
			LinkedList<SubstrateLink> linkBandwidthInput, Map<PhysicalServer, SubstrateSwitch> listLinksServerInput,
			Map<Integer, PhysicalServer> listPhyServersInput, LinkedList<LinkPhyEdge> listLinkPhyEdgeInput,
			LinkedList<SubstrateSwitch> listSwitchInput,
			Map<SubstrateSwitch, LinkedList<SubstrateSwitch>> listAggConnectEdgeInput,
			Map<SubstrateSwitch, LinkedList<SubstrateSwitch>> listCoreConnectAggInput,
			Map<Integer, LinkedList<SubstrateSwitch>> listEdgeSwitchInPodInput,
			Map<Integer, LinkedList<SubstrateSwitch>> listAggSwitchInPodInput,
			LinkedList<SubstrateSwitch> listPhySwitchInput) {
		map = mapInput;
	...
	public Map<SubstrateSwitch, SubstrateSwitch> getListCoreToCore() {
		return listCoreToCore;
	}

	public void setListCoreToCore(Map<SubstrateSwitch, SubstrateSwitch> listCoreToCore) {
		this.listCoreToCore = listCoreToCore;
	}
	...
	public double getUtilzation() {
		...
		double totalBW = 0;
		for (SubstrateLink link : linkBandwidth) {
			totalBW += (1000 - link.getBandwidth());
//			System.out.println("LinkBW " +link.getBandwidth());
			// BW += 1000;
		}
	...
	public Object clone() {
		Topology t = new Topology(map, linkBandwidth, listLinksServer, listPhyServers, listLinkPhyEdge, listSwitch,
				listAggConnectEdge, listCoreConnectAgg, listEdgeSwitchInPod, listAggSwitchInPod, listPhySwitch);
		return t;
	}
}
