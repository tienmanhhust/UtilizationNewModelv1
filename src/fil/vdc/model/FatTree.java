...
public class FatTree {
	...
	private Map<Integer, LinkedList<SubstrateSwitch>> listPod; // list edge switch in pod
	private Map<Integer, LinkedList<SubstrateSwitch>> listPodAgg; // list agg switch in pod
	//for link mapping
	...
	public Map<SubstrateSwitch, SubstrateSwitch> listCoretoCore;
	public FatTree() {
		this.k = 0;
	...
	public FatTree(Map<Integer, SubstrateSwitch> listEdgeSwitch, Map<Integer, SubstrateSwitch> listAggSwitch,Map<Integer, SubstrateSwitch> listCoreSwitch
			,Map<Integer, PhysicalServer> listPhysicalServer, Map<Integer, LinkedList<SubstrateSwitch>> listPod, Map<Integer, LinkedList<SubstrateSwitch>> listPodAgg,
			int k,int totalCore, int totalAgg, int totalEdge, int totalHost, Map<SubstrateSwitch, LinkedList<SubstrateSwitch>> listAggConnectEdge,Map<SubstrateSwitch, LinkedList<SubstrateSwitch>> listCoreConnectAgg ){
		this.k = k;
...
public Object clone(){
		...
		FatTree fat = new FatTree(listEdgeSwitch,listAggSwitch,listCoreSwitch
				, listPhysicalServer, listPod,listPodAgg,
				 k, totalCore, totalAgg,totalEdge, totalHost,listAggConnectEdge,listCoreConnectAgg);
		return fat;
	}
